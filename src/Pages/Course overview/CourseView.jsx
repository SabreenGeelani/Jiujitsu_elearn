...
{ reviewsLoading ? <l-grid
                  ...
                  ></l-grid> : <>
                    ...
                    <div className="right-ratings-courseview">
                      ...
                      <div>
                        ...
                        <div>
                          <div style={{width:`${reviewData?.data?.ratingPercentages[3]}%`}} className="thirty-rating-courseview"></div>
                        </div>
                      </div>
                      <div>
            ...
            <div className="right-bottom-courseview">
              <div className="heading-bottom-courseview">
                ...
                <h6>Lecture ({courseData2[0]?.total_lesson}) Total ({formatTime(courseData2[0]?.total_duration)})</h6>
              </div>
      ...
      >
        <summary>
          ...
          />
                ...
                <div style={{display:"flex", justifyContent:"center", alignItems:"center", width:"100%",padding:"2vh 0 1vh 0"}}>
